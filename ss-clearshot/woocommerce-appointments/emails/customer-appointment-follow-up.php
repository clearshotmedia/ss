...
printf( esc_html__( 'Please confirm that Appointment number %1$s took place, complete and save the booking record.', 'woocommerce-appointments' ), esc_html( $appointment->get_id() ) );
?>
...
<p>
		...
		printf( esc_html__( 'Go to booking record: %s', 'woocommerce-appointments' ), '<a href="' . esc_url( $order_url ) . '">' . esc_html__( 'Click here', 'woocommerce-appointments' ) . '</a>' );
		?>
		</p>
