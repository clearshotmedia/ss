...
<?php if ( $appointment->get_start_date( wc_date_format(), '' ) === date( wc_date_format() ) ) : ?>
	...
	printf( esc_html__( 'Your appointment is starting soon at %1$s - use the link below to join the video call:', 'woocommerce-appointments' ), esc_html( $appointment->get_start_date() ) );
	?></p>
