		...
		<table class="shop_table shop_table_responsive my_account_appointments <?php echo esc_html( $table_id ) . '_appointments'; ?>">
			<thead>
				<tr>
					...
					<th scope="col" class="appointment-actions"><span class="nobr"><?php esc_html_e( 'Actions', 'woocommerce-appointments' ); ?></th>
					<th scope="col" class="zoom-link"><span class="nobr"><?php esc_html_e( 'Zoom Link', 'woocommerce-appointments' ); ?></th>
				</tr>
			</thead>
			<tbody>
					...
					<tr>
						<td class="appointment-id anowrap" data-title="<?php esc_html_e( 'Appointment', 'woocommerce-appointments' ); ?>">
							...
							printf(
								...
								esc_attr( $appointment->get_order()->get_id() )
							);
						...
						<td class="zoom-link" data-title="<?php esc_html_e( 'Zoom URL', 'woocommerce-appointments' ); ?>">
						<?php $join_url = get_post_meta( $order->get_order_number(), 'zoom_join_url', true );
