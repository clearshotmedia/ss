...
<p class="form-field form-field-wide <?php echo esc_attr( implode( ' ', $class ) ); ?>">
	<label class="booking-instructions" for="<?php echo esc_html( $name ); ?>">1. <?php echo esc_html( $label ); ?></label>
	<select name="<?php echo esc_html( $name ); ?>" id="<?php echo esc_html( $name ); ?>">
		<?php if ( $nopref ) : ?>
			<option value=""><?php esc_html_e( 'Any Provider', 'woocommerce-appointments' ); ?></option>
		<?php endif; ?>
